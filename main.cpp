...
public:
    ...
    // Función para dibujar utilizando (si text==1) el shader de texturas
    ...
    virtual void OnRender(void) {
        ...
        // Granjas (índice 0), silla (índice 1), pinocchio (índice 2) y cadena (índice 3)
    ...
    // Configuración básica de la iluminación
    void DemoLight(void) {
